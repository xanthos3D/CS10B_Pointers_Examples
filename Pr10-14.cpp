...
int countChars(char *, char,char);  // Function prototype
...
int main()
{
   ...
   char letter, rchar;
   string aword;            // The character to count
   ...
   cin >> letter;
   cout<<"enter another character to use as a replacement: ";
   cin>>rchar;

   // Display the number of times the character appears.
   cout << letter << " appears ";
   cout << countChars(userString, letter,rchar) << " times.\n";
...
int countChars(char *strPtr, char ch,char rch)
{
